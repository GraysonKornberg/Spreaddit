...
const config = {
  ...
  scopes: [
    'identity, submit, flair, edit, history, modconfig, modflair, modlog, modposts, modwiki, mysubreddits, privatemessages, read, report, save, subscribe, vote, wikiedit, wikiread',
  ],
